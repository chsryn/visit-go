...
/**
 * Estimasi biaya dari database: tampil tepat setelah summary.
 * Tiket/wahana per destinasi hasil + harga kuliner sesuai preferensi.
 */
        ...
        <div className="rounded-[15px] border border-white/30 bg-white/65 backdrop-blur-xl p-6 shadow-soft">
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3">
                    <p className="font-mono text-xl font-bold text-black">{rupiah(estimate.total)}</p>
                    <button
                        type="button"
