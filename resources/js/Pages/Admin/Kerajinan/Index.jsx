...
export default function KerajinanIndex({ items }) {
    return (
        <>
            <Head title="Kerajinan — Admin" />
            <AdminLayout title="Kerajinan" subtitle="CRUD tabel kerajinans — sulaman Karawo, anyaman, dan lainnya.">
                <ResourceManager
                    items={items}
                    basePath="/admin/kerajinans"
                    fields={[
