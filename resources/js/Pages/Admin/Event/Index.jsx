...
export default function EventIndex({ items }) {
    return (
        <>
            <Head title="Event — Admin" />
            <AdminLayout title="Event" subtitle="CRUD tabel events — location_name + koordinat desimal.">
                <ResourceManager
                    items={items}
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-0.5 text-xs text-muted-foreground">
                                            {row.date} · {row.month} · {row.display_location}
                                        </p>
                                    </div>
                                </div>
                            ),
