...
class GroundingBuilder
{
    ...
    public function scopedContext(string $location, array $interests, string $foodPref = ''): array
    {
        try {
            ...
            // Baris bertag cocok diurutkan dulu agar preferensi (halal/pedas/dll) akurat.
     ...
     *
     * @return array {destinations:[{name,slug,entry_fee,items[]}], foods:[{name,harga}], total:int, currency:string}
     */
